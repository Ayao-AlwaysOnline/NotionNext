...
export const MenuList = props => {
  ...
  return (
    <div>
      ...
      <nav
        id='navbarCollapse'
        className={`absolute right-4 top-full w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-dark-2 lg:static lg:block lg:w-full lg:max-w-full lg:px-4 lg:py-0 lg:shadow-none xl:px-6 ${
          showMenu ? '' : 'hidden'
        }`}>
