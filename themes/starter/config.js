...
const CONFIG = {
  ...
  STARTER_ABOUT_IMAGE_1: '/images/starter/team/s1.webp',
  STARTER_ABOUT_IMAGE_2: '/images/starter/team/s2.webp',
  ...
  // 嵌入外部表单
  STARTER_CONTACT_MSG_EXTERNAL_URL: 'https://noteforms.com/forms/website-seaportcy-98qots', // 基于NoteForm创建，将留言数据存在Notion中
  //   自定义留言表单，以下几个配置暂时废弃
