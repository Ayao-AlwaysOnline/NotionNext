...
.common-carousel .swiper-button-prev svg{
  ...
  /* ============================================================
     ...
     ============================================================ */
  #theme-proxio .rounded-xl.bg-white.shadow-pricing,
  #theme-proxio .rounded-xl.bg-white.shadow-testimonial,
  #theme-proxio .rounded-xl.bg-white.overflow-hidden,
  #theme-proxio .mb-8.overflow-hidden.rounded-\[5px\],
  #theme-proxio .rounded-xl.dark\:bg-dark,
  #theme-proxio .rounded-xl.dark\:bg-dark-2 {
  ...
  #theme-proxio .rounded-xl.bg-white.shadow-pricing:hover,
  #theme-proxio .rounded-xl.bg-white.shadow-testimonial:hover,
  #theme-proxio .mb-8.overflow-hidden.rounded-\[5px\]:hover {
  ...
  #theme-proxio .bg-white.pb-12.pt-20,
  #theme-proxio .bg-white.pb-10.pt-20,
  #theme-proxio .bg-gray-1.py-20,
  #theme-proxio .bg-gray-1.pb-12.pt-20 {
