                            ...
                            <div className="text-center lg:text-left lg:max-w-xl">
                                ...
                                <form ref={formRef} className="w-full lg:w-auto">
                                    <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                                        ...
                                        <button disabled={success} type='submit' className={`btn text-white  shadow ${success ? 'bg-green-600 hover:bg-green-700' : 'bg-primary hover:bg-[#d9a83f]'}`} href="#0">{success ? 'Subscribed' : 'Subscribe'}</button>
                                    </div>
                                    {/* Success message */}
