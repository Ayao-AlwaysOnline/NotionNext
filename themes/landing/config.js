const CONFIG = {
  ...
  LANDING_HEADER_BUTTON_2_TITLE: '日本语',
  LANDING_HEADER_BUTTON_2_URL: 'https://seaportcy.com/studios-ja',
  ...
  LANDING_FEATURES_CARD_2_TITLE: '完善的解决能力',
  LANDING_FEATURES_CARD_2_P: '无论您的问题是什么，我们都具备回应与解决的能力',
  LANDING_FEATURES_CARD_3_TITLE: '可被长期依赖的服务关系',
  LANDING_FEATURES_CARD_3_P: '我们选择留下，而不是一次次重新开始',

  // 特性介绍2
  LANDING_FEATURES_BLOCK_HEADER: '解决方案',
  LANDING_FEATURES_BLOCK_P: '信息高度溢出的时代，一个团队的幕后存在为您解决诸多需求，带给你无限的体验、机遇和客户。<br/>您还在等什么呢？',
  LANDING_FEATURES_BLOCK_1_TITLE: '建站服务',
  LANDING_FEATURES_BLOCK_1_P: '用网站来展示品牌，比起线下渠道、一个公开域名和网站更能帮助您实现成长和可持续发展！',
  LANDING_FEATURES_BLOCK_2_TITLE: '数字战略咨询/技术陪伴',
  LANDING_FEATURES_BLOCK_2_P: '一个疑问的存在就会有一个答案的诞生',
  LANDING_FEATURES_BLOCK_3_TITLE: '设计产出',
  LANDING_FEATURES_BLOCK_3_P: '解决需求，或创造您的风格',
  LANDING_FEATURES_BLOCK_4_TITLE: '媒体服务',
  LANDING_FEATURES_BLOCK_4_P: '无论是宣传图/视频，还是广告或纪录片，影像的存在，是为了让品牌被记住',
  LANDING_FEATURES_BLOCK_5_TITLE: '线上/下专属委托',
  LANDING_FEATURES_BLOCK_5_P: '专属的团队成员，线上或线下，为您承接、判断、推进',
  LANDING_FEATURES_BLOCK_6_TITLE: '非公开/定制委托',
  LANDING_FEATURES_BLOCK_6_P: '您需要，我们就在；您不提及的，我们从未存在',
  ...
  LANDING_TESTIMONIALS_WORD: '“通过他们的服务有了一个独属于我们的站点后，询单和成交订单呈指数级上涨，作为背书也很稳妥“',
  ...
  LANDING_PRICING_1_TITLE: '分支业务',
  LANDING_PRICING_1_PRICE: '设计与策略咨询',
  LANDING_PRICING_1_CONTENT: '徽标与界面设计,品牌数字形象,线上战略咨询,长期技术答疑',
  ...
  LANDING_PRICING_3_TITLE: '定制服务',
  LANDING_PRICING_3_PRICE: '委托与长期协同',
